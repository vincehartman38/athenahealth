...
class APIConnection(object):
    ...
    def __init__(self, version, key, secret, practiceid=None, test=False):
        ...
        """
        self._host = 'api.preview.platform.athenahealth.com' if test else 'api.platform.athenahealth.com'
        self._version = version
        self._connection = http.client.HTTPSConnection(self._host)
        self._auth_url = '/oauth2/'+self._version
        self._key = key
        self._secret = secret
        self._authenticate()
